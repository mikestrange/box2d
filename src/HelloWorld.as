package{
	...
	public class HelloWorld extends Sprite{
		...
		public function HelloWorld(){
			...
			// Creat world AABB  创建一个2D世界
			var worldAABB:b2AABB = new b2AABB();
			worldAABB.lowerBound.Set(-100.0, -100.0);//上届 
			worldAABB.upperBound.Set(100.0, 100.0);
			
			// Define the gravity vector 定义矢量重力
			var gravity:b2Vec2 = new b2Vec2(0, 9.8);
			
			// Allow bodies to sleep  让身体 睡眠
			var doSleep:Boolean = true;
			
			// Construct a world object   构建一个世界对象
			m_world = new b2World(worldAABB, gravity, doSleep);
			
			// set debug draw  这里是给物体加线条
			/*
			...
			*/
			...
			// Vars used to create bodies  变量用于创建体
			var body:b2Body;
			...
			bodyDef.userData.height = 10 * 2 * 3; 
